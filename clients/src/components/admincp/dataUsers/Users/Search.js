...
function Search(props) {
    ...
    const initialValues = {
        full_name: query.full_name ? query.full_name : "",
        ...
        gender: query.gender ? parseInt(query.gender) : null,
    }
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="full_name"  label={langs.user_name} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="email"  label="Email" component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="phone"  label={langs.phone} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
