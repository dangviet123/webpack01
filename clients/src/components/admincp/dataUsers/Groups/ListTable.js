        ...
        xhtml = datas.map((data,index) => {
            return (
                <TableRow hover key={index}>
                    ...
                    <TableCell align="center">{data.GroupsName}</TableCell>
                    ...
                    <TableCell align="center">
                        <Tooltip title={data.Active ? langs.activate : langs.inactive} placement="left" arrow>
                            <FormControlLabel className="switch_nomag"
                                control={<Switch color="primary"   checked={data.Active ? true: false}  onChange={() => activeOne(data.idGroups,data.Active)}  />}
        ...
        <div className="table_wp">
            <Table aria-label="simple table" >
                ...
                <TableRow>
                    ...
                    <TableCell align="center">{langs.group_name}</TableCell>
