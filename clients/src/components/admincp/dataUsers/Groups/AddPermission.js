...
import { ac_checkOnePermission, ac_checkAllPermission, ac_savePermission } from "../../../../actions/admincp/dataUsers/Groups";
function AddPermission(props) {
    const {idMenu,idTypeMenu,idGroups} = props;
    const dispatch = useDispatch();
    const {Listpermision} = useSelector(state => state.GroupListMenu);
