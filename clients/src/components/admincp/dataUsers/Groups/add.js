...
function Add(props) {
    ...
    return (
        <div>
            <Formik
                initialValues={{ GroupsName: '',Description: '',Active: true}}
                onSubmit={(value) => props.addGroups(value)}
                    ...
                    <Form onSubmit={handleSubmit}>
                        <DialogContent style={{overflow: 'hiden'}}>
                            <Grid container spacing={2} >
                                <Grid item xs={12}>
                                    <FastField name="GroupsName"  label={langs.group_name} component={FmTextField} fullWidth margin="dense" size="small"  />
                                </Grid>
                                <Grid item xs={12}>
