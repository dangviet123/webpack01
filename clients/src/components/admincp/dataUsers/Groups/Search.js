...
function Search(props) {
    ...
    const initialValues = {
        GroupsName: query.GroupsName ? query.GroupsName : "",
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="GroupsName"  label={langs.group_name} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
