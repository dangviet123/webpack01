...
import { Tooltip, FormControlLabel, Switch, Icon } from '@material-ui/core';
        ...
        xhtml = datas.map((data,index) => {
            return (
                <TableRow hover key={index}>
                    ...
                    <TableCell align="center">{data.ListPermissionName}</TableCell>
                    <TableCell align="center">{data.Description}</TableCell>
                    <TableCell align="center"><Icon className={data.Icon} color="action" fontSize="small" ></Icon></TableCell>
                    ...
                    <TableCell align="center">
                        <Tooltip title={data.Active ? langs.activate : langs.inactive} placement="left" arrow>
                            <FormControlLabel className="switch_nomag"
                                control={<Switch color="primary"  checked={data.Active ? true: false}  onChange={() => activeOne(data.idListPermission,data.Active)}  />}
        ...
        <div className="table_wp">
            <Table aria-label="simple table" >
                ...
                <TableRow>
                    ...
                    <TableCell align="center">{langs.list_premission_name}</TableCell>
                    <TableCell align="center">{langs.description}</TableCell>
                    <TableCell align="center" width={200}>{langs.icon}</TableCell>
