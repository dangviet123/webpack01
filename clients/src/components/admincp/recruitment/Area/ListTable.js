                    ...
                    <TableCell align="center">
                        <Tooltip title={data.Active ? langs.activate : langs.inactive} placement="left" arrow>
                            <FormControlLabel className="switch_nomag"
                                control={<Switch color="primary"   checked={data.Active ? true: false}  onChange={() => activeOne(data.idArea,data.Active)}  />}
        ...
        <div className="table_wp">
            <Table aria-label="simple table" >
                ...
                <TableRow>
                    ...
                    <TableCell align="center" width={100}>{langs.longitude}</TableCell>
                    <TableCell align="center" width={100}>{langs.latitude}</TableCell>
                    <TableCell align="center" width={120}>{langs.user_create}</TableCell>
                    <TableCell align="center" width={100}>{langs.date_create}</TableCell>
                    <TableCell align="center" width={70}>{langs.order_by}</TableCell>
