...
function Search(props) {
    ...
    const initialValues = {
        Profile: query.Profile ? query.Profile : "",
        ...
        idGender: query.idGender ? parseInt(query.idGender) : null,
        idMarriage: query.idMarriage ? parseInt(query.idMarriage) : null,
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="Profile"  label={langs.title} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="FullName"  label={langs.full_name} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="Recruit"  label={langs.vacancies} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField  
