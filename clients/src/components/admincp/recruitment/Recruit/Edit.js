...
function Edit(props) {
    const {editRecruit,isSubmitForm,ListArea,ListVacancies,edit} = props;
    const initialValues = {
        Recruit: edit.Recruit ? edit.Recruit : '',
        Wage: edit.Wage ? edit.Wage : '',
        idArea: edit.idArea ? edit.idArea : '',
        idVacancies: edit.idVacancies ? edit.idVacancies : '',
        Content: edit.Content ? edit.Content : '',
        GroupArea: edit.GroupArea ? edit.GroupArea : '',
        Startday: edit.Startday ? edit.Startday : new Date(),
        DateFinish: edit.DateFinish ? edit.DateFinish : new Date(),
        Active: edit.Active===1 ? true : false,
    };
    const handleEditRecruit =(value) => {
    ...
    return (
        <div>
            <Formik
                ...
                onSubmit={(value) => handleEditRecruit(value)}
