...
function Search(props) {
    ...
    const initialValues = {
        PostsTitle: query.PostsTitle ? query.PostsTitle : "",
        ...
        idMenu: query.idMenu ? parseInt(query.idMenu) : null,
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="PostsTitle"  label={langs.title} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
