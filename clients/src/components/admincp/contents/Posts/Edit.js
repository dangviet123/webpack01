...
function Edit(props) {
    ...
    const {handleShowAddSlide,
        editPosts,ListGroupTitle,
        isSubmitForm,
        edit,
        ListCategory} = props;

    const initialValues = {
        PostsTitle: edit.PostsTitle ? edit.PostsTitle :  '',
        Description: edit.Description ? edit.Description : '',
        idMenu: edit.idMenu ? edit.idMenu : '',
        idGroupTitle: edit.idGroupTitle ? edit.idGroupTitle : '',
        Image: edit.Image ? edit.Image : '',
        Image_ol: edit.Image ? edit.Image : '',
        Content: edit.Content ? edit.Content : '',
        LinkYoutube: edit.LinkYoutube ? edit.LinkYoutube : '',
        ImageSlide: [],
    ...
    return (
        <div>
            <Formik
                ...
                onSubmit={(value) => editPosts(value)}
                                    ...
                                    <Grid item xs={12} md={6}>
                                        ...
                                        </div>
                                        {
                                            values.Image !== '' ? <div className={classes.box_img}>
                                                <img className={classes.image_s} src={values.Image !== values.Image_ol ? values.Image : `${link_event}/thumb/${values.Image_ol}`} alt={values.PostsTitle} />
                                            </div> : ''
                                        }
                                    </Grid>
                                    <Grid item xs={12} md={6}>
