...
function Search(props) {
    ...
    const initialValues = {
        GroupTitle: query.GroupTitle ? query.GroupTitle : "",
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="GroupTitle"  label={langs.group_title} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
