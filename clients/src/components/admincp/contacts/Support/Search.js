...
function Search(props) {
    ...
    const LitsActive = [
        { title: langs.active_process, value: 1 },
        { title: langs.inactive_process, value: 0 }
    ];
    return (
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="Support"  label={langs.title} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="Content"  label={langs.notes} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
                                        ...
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField  
                                                ...
                                                variant="inline"
                                                format="DD-MM-YYYY"
                                                label={langs.date_sent_support_from}
                                        ...
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField  
                                                ...
                                                variant="inline"
                                                format="DD-MM-YYYY"
                                                label={langs.date_sent_support_to}
                                                fullWidth  size="small"
                                            />
