                ...
                <TableRow hover key={index}>
                    ...
                    <TableCell align="center">
                        <Tooltip title={langs.view_picture} placement="right"   arrow>
                            <img onClick={() => viewImage(index)} src={`${link_home}thumb/${data.Image}`} alt={``}  />
                        </Tooltip>
                    </TableCell>
                    <TableCell align="center" >{data.MenuName}</TableCell>
                    <TableCell align="center">{data.StepsTitle}</TableCell>
                    ...
                    <TableCell align="center">
                        <Tooltip title={data.Active ? langs.activate : langs.inactive} placement="left" arrow>
                            <FormControlLabel className="switch_nomag"
                                control={<Switch color="primary"   checked={data.Active ? true: false}  onChange={() => activeOne(data.idSteps,data.Active)}  />}
        ...
        <div className="table_wp">
            <Table aria-label="simple table" >
                ...
                <TableRow>
                    ...
                    <TableCell align="center" width={80}>{langs.picture}</TableCell>
