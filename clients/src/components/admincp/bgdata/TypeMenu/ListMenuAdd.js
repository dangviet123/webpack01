                    ...
                    <Form onSubmit={handleSubmit} onBlur={handleBlur} onChange={handleChange}>
                        <DialogContent style={{overflow: 'hiden'}}>
                            <Grid container spacing={3} >
                                <Grid item xs={12}>
                                    <FastField name="MenuName"  label={langs.name_menu} component={FmTextField} fullWidth  size="small"  />
                                </Grid>
                                <Grid item xs={12}>
                                    <Field 
                                ...
                                <Grid item xs={12}>
                                    ...
                                    <Field error={['ListMenu', 'checkSlug']} message={SLUGUNIQUE}  name="Slug"
                                        ...
                                        label={`Slug`}
                                        onBlur={e => {
                                            dispath(ac_checkSlug(e.target.value,0,idTypeMenu,values.id_parent));
                                        }}
                                        component={FmTextFieldCheckApi} fullWidth  size="small"  />
                                </Grid>
                                
                                <Grid item xs={12}>
                                    <FastField name="Description"  label={langs.description} component={FmTextField} fullWidth  size="small"  />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <FastField name="Target"   label="Target" component={FmTextField} fullWidth  size="small"  />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <FastField name="Link"  label={langs.link} component={FmTextField} fullWidth  size="small"  />
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <FastField name="Icon"  label={langs.icon} component={FmTextField} fullWidth  size="small"  />
                                </Grid>
                                <Grid item xs={12} md={6}>
