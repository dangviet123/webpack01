...
function Search(props) {
    ...
    const initialValues = {
        TypeMenuName: query.TypeMenuName ? query.TypeMenuName : "",
                                ...
                                <div className="serach_content">
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6} lg={4}>
                                            <FastField name="TypeMenuName"  label={langs.name_menu_type} component={FmTextField} fullWidth  size="small" variant="standard" />
                                        </Grid>
                                        <Grid item xs={12} sm={6} lg={4}>
