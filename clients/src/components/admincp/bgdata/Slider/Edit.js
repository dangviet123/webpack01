...
const validationSchema = Yup.object().shape({
    SliderTitle: Yup.string().required(EMPTY_FIELD).min(3,MIN3).max(225,MAX225),
...
function Edit(props) {
    ...
    const initialValues = {
        SliderTitle: edit.SliderTitle ? edit.SliderTitle : '',
    ...
    return (
        <div>
            <Formik
                ...
                onSubmit={(value) => props.editSlider(value)}
                    ...
                    <Form onSubmit={handleSubmit} >
                            <div className="content_add_new">
                                <Grid container spacing={3}>
                                    <Grid item xs={12}>
                                        <FastField name="SliderTitle"  label={langs.title} component={FmTextField} fullWidth margin="dense" size="small"  />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <Field
                                    ...
                                    <Grid item xs={12}>
                                        {
                                            values.Image !== '' ? <div className={classes.box_img}>
                                                <img className={classes.image_s} src={values.Image !== values.Image_ol ? values.Image : `${link_breadcrumb}/thumb/${values.Image_ol}`} alt={``} />
                                            </div> : ''
                                        }
